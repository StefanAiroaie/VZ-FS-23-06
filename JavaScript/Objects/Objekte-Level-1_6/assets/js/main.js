...
// console.log(myMusic[3].title.length);
console.log(myMusic[3].title.substring(17, 21));

// console.log(myMusic[2].title.length);
console.log(myMusic[2].title.substring(13, 15));

// console.log(myMusic[1].kunstler.length);
console.log(myMusic[1].kunstler.substring(5, 10));
